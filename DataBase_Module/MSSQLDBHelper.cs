...
namespace DataBase_Module
{
    ...
    public class MSSQLDBHelper
    {
        ...
        public object ExecuteScalar(string databasename, string sql)
        {
        ...
        /// <returns>object</returns>
        public object ExecuteScalar(string databasename, string sql, SqlParameter[] parameters)
        {
            object result = null;
            try
            {
        ...
        /// <param name="sql"></param>
        /// <returns>int</returns>
        public int ExecuteNonQuery(string databasename, string sql)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns>int</returns>
        public int ExecuteNonQuery(string databasename, string sql, SqlParameter[] parameters)
        {
            int result = -1;
            try
            {
        ...
        public SqlDataReader ExecuteReader(string databasename, string sql)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns>SqlDataReader</returns>
        public SqlDataReader ExecuteReader(string databasename, string sql, SqlParameter[] parameters)
        {
        ...
        public DataTable ExecuteTable(string databasename, string sql)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns>DataTable</returns>
        public DataTable ExecuteTable(string databasename, string sql, SqlParameter[] parameters)
        {
        ...
        public Hashtable RunProcedure(string databasename, String procedureName)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns>int</returns>
        public Hashtable RunProcedure(string databasename, String procedureName, SqlParameter[] parameters)
        {
        ...
        public int ExecProcedure(string databasename, String procedureName)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns>int</returns>
        public int ExecProcedure(string databasename, String procedureName, SqlParameter[] parameters)
        {
            int result = -1;
            try
            {
        ...
        /// <param name="procedureName"></param>
        /// <returns>Object</returns>
        public Object ProcedureScalar(string databasename, String procedureName)
        {
            return ExecProcedure(databasename, procedureName, null);
        }
        ...
        /// <param name="parameters"></param>
        /// <returns>Object</returns>
        public Object ProcedureScalar(string databasename, String procedureName, SqlParameter[] parameters)
        {
            Object result = null;
            try
            {
        ...
        /// <param name="procedureName"></param>
        /// <returns>SqlDataReader</returns>
        public SqlDataReader ProcedureReader(string databasename, String procedureName)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns>SqlDataReader</returns>
        public SqlDataReader ProcedureReader(string databasename, String procedureName, SqlParameter[] parameters)
        {
            SqlDataReader result = null;
            try
            {
        ...
        /// <param name="procedureName"></param>
        /// <returns>DataTable</returns>
        public DataTable ProcedureTable(string databasename, String procedureName)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns>DataTable</returns>
        public DataTable ProcedureTable(string databasename, String procedureName, SqlParameter[] parameters)
        {
            DataTable result = null;
            try
            {
        ...
        /// <returns>DataTable</returns>
        public DataTable ProcedureTable(string databasename, String procedureName, SqlParameter[] parameters, out int recordCount)
        {
            DataTable dt = null;
            recordCount = 0;
            try
