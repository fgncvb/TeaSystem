...
///验证是否有非法字符
function checkStrSafe(inputStr) {
    var re = /\/|\\|=|\&|\$|%|\|@|,|'|<|>|》|《|\*|\^|~|#|\(|\)^/g;
    if (re.test(inputStr) == true) {
        return true
    }
    return false;
...
{
    //return strMobile.match(/^1[3|4|5|7|8][0-9]\d{4,8}$/);
    var regu = /^1[3|4|5|7|8][0-9]\d{8}$/; // /^[1][3][0-9]{9}$/;
...
function checkPhone( strPhone ) 
{
    ...
    //var phoneRegWithArea = /^[0][1-9]{3,4}-[0-9]{7,8}$/;
    //var phoneRegNoArea = /^[1-9]{1}[0-9]{7,8}$/;
